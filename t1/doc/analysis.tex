...
In additional, we can use given equations, $I_b=K_bV_b$ and $I_c=\frac{V_c}{K_c}$, to confirm values obtained before, in mesh analysis: $I_b=-0.307188$ mA; $I_b=0.937495$ mA.
